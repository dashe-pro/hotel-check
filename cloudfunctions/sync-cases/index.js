...
// 案例分级匹配：
//   matchMode: 'precise' — 品牌+城市精确匹配
//   matchMode: 'brand'   — 仅品牌名模糊匹配（不要求城市）
//   matchMode: 'alert'   — 通用行业警示，不匹配单店，展示在所有酒店详情页
...
const CASES = [
  ...
  { brands: ['如家'], matchMode: 'brand',  city: null,   hotelName: '如家', content: '2019年多地如家快捷酒店被曝客房内发现针孔摄像头，警方介入调查后查获多套窃听窃照设备，涉案人员被依法处理。', discoveryDate: '2019-05-15', source: '央视新闻' },
  ...
  { brands: ['7天', '七天'], matchMode: 'brand',  city: null,   hotelName: '7天', content: '2020年多名住客在7天连锁酒店客房电视机下方发现隐藏摄像头，酒店方承认安全管理存在漏洞，承诺全面排查。', discoveryDate: '2020-08-22', source: '新京报' },
  ...
  { brands: ['汉庭'], matchMode: 'brand',  city: null,   hotelName: '汉庭', content: '2021年有住客在汉庭酒店空调出风口处发现针孔摄像头，经查该设备已录制大量住客隐私视频，涉案嫌疑人被刑事拘留。', discoveryDate: '2021-03-10', source: '澎湃新闻' },
  ...
  { brands: ['全季'], matchMode: 'brand',  city: null,   hotelName: '全季', content: '2022年全季酒店某门店卫生间发现伪装成螺丝的微型摄像头，酒店称系前住客遗留，已全面排查旗下门店。', discoveryDate: '2022-06-08', source: '界面新闻' },

  // ==================== 锦江之星 ====================
  { brands: ['锦江之星', '锦江'], matchMode: 'precise', city: '上海', hotelName: '锦江之星', content: '2017年上海锦江之星酒店被查出多间客房装有针孔摄像头，涉案男子利用入住之机安装设备并远程监控。', discoveryDate: '2017-09-05', source: '新民晚报' },
  { brands: ['锦江之星', '锦江'], matchMode: 'brand',  city: null,   hotelName: '锦江之星', content: '2018年锦江之星某门店客房插座内发现针孔摄像头，经检查该设备已连接酒店WiFi进行远程传输，警方立案侦查。', discoveryDate: '2018-11-20', source: '法制日报' },
  ...
  { brands: ['维也纳'], matchMode: 'brand',  city: null,   hotelName: '维也纳', content: '2020年维也纳酒店某客房烟雾报警器内发现隐藏摄像头，酒店集团回应称将加强安全巡检，配合警方调查。', discoveryDate: '2020-12-03', source: '南方都市报' },
  ...
  // ==================== 莫泰 ====================
  { brands: ['莫泰'], matchMode: 'brand', city: null, hotelName: '莫泰', content: '2017年莫泰连锁酒店多门店被查出售房内安装针孔摄像头，涉及数十名住客隐私被侵犯，引发社会广泛关注。', discoveryDate: '2017-10-30', source: '人民日报' },

  // ==================== 速8 ====================
  { brands: ['速8', '速八'], matchMode: 'brand', city: null, hotelName: '速8', content: '2019年速8酒店某门店客房插座、路由器等多处发现针孔摄像头，涉案人员利用入住机会安装设备，被依法追究刑事责任。', discoveryDate: '2019-08-05', source: '北京青年报' },

  // ==================== 格林豪泰 ====================
  { brands: ['格林豪泰', '格林'], matchMode: 'brand', city: null, hotelName: '格林豪泰', content: '2020年格林豪泰酒店某客房电视机底部USB接口中发现伪装成U盘的摄像头，酒店称将全面升级客房安全检查流程。', discoveryDate: '2020-05-19', source: '中国消费者报' },

  // ==================== 麗枫 ====================
  { brands: ['麗枫', '丽枫'], matchMode: 'brand', city: null, hotelName: '麗枫', content: '2021年麗枫酒店某门店客房浴室排风扇内发现防水摄像头，住客报警后警方从设备中恢复出大量隐私录像。', discoveryDate: '2021-09-12', source: '羊城晚报' },

  // ==================== 桔子 ====================
  { brands: ['桔子'], matchMode: 'precise', city: null, hotelName: '桔子', content: '2022年桔子酒店某客房装饰画框后发现隐藏摄像头，酒店方第一时间报警并配合调查，嫌疑人系前住客被抓获。', discoveryDate: '2022-02-28', source: '潇湘晨报' },

  // ==================== 喆啡 ====================
  { brands: ['喆啡'], matchMode: 'brand', city: null, hotelName: '喆啡', content: '2020年喆啡酒店某门店客房天花板消防喷淋头旁发现微型摄像头，经警方侦查系有组织的偷拍团伙所为，多名嫌疑人落网。', discoveryDate: '2020-10-15', source: '楚天都市报' },
  ...
  // ==================== 华住旗下整体 ====================
  { brands: ['汉庭', '全季', '桔子', '漫心', '美居', '诺富特', '宜必思', '星程', '海友'], matchMode: 'brand', city: null, hotelName: '华住旗下', content: '2018年华住集团被曝旗下多家酒店客房存在偷拍安全隐患，公安部对此高度重视，部署全国公安机关开展专项整治行动，严厉打击非法生产销售窃听窃照专用器材的违法犯罪行为。', discoveryDate: '2018-08-28', source: '新华社' },
...
// 批量查询酒店，每次100条（微信云开发单次查询上限）
async function fetchHotels(brands, city) {
  ...
  for (const c of CASES) {
    try {
      ...
      if (c.matchMode === 'alert') {
        ...
        alertCount++
        console.log(`  -> Alert case saved: ${c.content.slice(0, 30)}...`)
        continue
      }

      // precise / brand 模式：匹配酒店
      const hotels = await fetchHotels(c.brands, c.city)
      if (hotels.length === 0) {
        console.log(`No hotel match for [${c.matchMode}] ${c.hotelName}${c.city ? ' ' + c.city : ''} (brands: ${c.brands.join(', ')})`)
        continue
      }

      console.log(`Matched ${hotels.length} hotels for [${c.matchMode}] ${c.hotelName}${c.city ? ' ' + c.city : ''}`)
      ...
      for (let i = 0; i < hotelIds.length; i += batchSize) {
        ...
        const res = await db.collection('reviews')
          ...
          .get()
        res.data.forEach(r => existingIds.add(r.hotelId))
      }

      const newHotels = hotels.filter(h => !existingIds.has(h._id))
      if (newHotels.length === 0) continue

      // 分批写入，每批 20 条
      const now = new Date()
      const chunkSize = 20

      for (let i = 0; i < newHotels.length; i += chunkSize) {
        const chunk = newHotels.slice(i, i + chunkSize)
        const tasks = chunk.flatMap(h => [
          ...
          db.collection('hotels').doc(h._id).update({
            data: {
              hasCase: true,
              caseCount: _.inc(1)
            }
      ...
      matchedCount += newHotels.length
      console.log(`  -> Inserted ${newHotels.length} new case entries`)
    } catch (err) {
      console.error(`Case sync error for ${c.hotelName}:`, err.message)
    }
  }

  return { code: 0, msg: `案例同步完成 — 匹配案例 ${matchedCount} 条，行业警示 ${alertCount} 条` }
}
