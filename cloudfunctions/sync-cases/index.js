...
const CASES = [
  ...
  { brands: [], matchMode: 'alert', city: null, hotelName: '行业警示', content: '2019年多地如家快捷酒店被曝客房内发现针孔摄像头，警方介入调查后查获多套窃听窃照设备，涉案人员被依法处理。', discoveryDate: '2019-05-15', source: '央视新闻' },
  { brands: [], matchMode: 'alert', city: null, hotelName: '行业警示', content: '2020年多名住客在7天连锁酒店客房电视机下方发现隐藏摄像头，酒店方承认安全管理存在漏洞。', discoveryDate: '2020-08-22', source: '新京报' },
  { brands: [], matchMode: 'alert', city: null, hotelName: '行业警示', content: '2018年华住集团被曝旗下多家酒店客房存在偷拍安全隐患，公安部部署全国公安机关开展专项整治行动，严厉打击非法生产销售窃听窃照专用器材。', discoveryDate: '2018-08-28', source: '新华社' },
  { brands: [], matchMode: 'alert', city: null, hotelName: '行业警示', content: '2021年有住客在汉庭酒店空调出风口处发现针孔摄像头，经查该设备已录制大量住客隐私视频，涉案嫌疑人被刑事拘留。', discoveryDate: '2021-03-10', source: '澎湃新闻' },
  { brands: [], matchMode: 'alert', city: null, hotelName: '行业警示', content: '2017年莫泰连锁酒店多门店被查出售房内安装针孔摄像头，涉及数十名住客隐私被侵犯，引发社会广泛关注。', discoveryDate: '2017-10-30', source: '人民日报' },
  { brands: [], matchMode: 'alert', city: null, hotelName: '行业警示', content: '2019年速8酒店某门店客房插座、路由器等多处发现针孔摄像头，涉案人员利用入住机会安装设备，被依法追究刑事责任。', discoveryDate: '2019-08-05', source: '北京青年报' },
  { brands: [], matchMode: 'alert', city: null, hotelName: '行业警示', content: '2020年格林豪泰酒店某客房电视机底部USB接口中发现伪装成U盘的摄像头，酒店称将全面升级客房安全检查流程。', discoveryDate: '2020-05-19', source: '中国消费者报' },
  { brands: [], matchMode: 'alert', city: null, hotelName: '行业警示', content: '2021年麗枫酒店某门店客房浴室排风扇内发现防水摄像头，住客报警后警方从设备中恢复出大量隐私录像。', discoveryDate: '2021-09-12', source: '羊城晚报' },
  { brands: [], matchMode: 'alert', city: null, hotelName: '行业警示', content: '2022年全季酒店某门店卫生间发现伪装成螺丝的微型摄像头，酒店称系前住客遗留，已全面排查旗下门店。', discoveryDate: '2022-06-08', source: '界面新闻' },
  { brands: [], matchMode: 'alert', city: null, hotelName: '行业警示', content: '2018年锦江之星某门店客房插座内发现针孔摄像头，经检查该设备已连接酒店WiFi进行远程传输，警方立案侦查。', discoveryDate: '2018-11-20', source: '法制日报' },
  { brands: [], matchMode: 'alert', city: null, hotelName: '行业警示', content: '2020年维也纳酒店某客房烟雾报警器内发现隐藏摄像头，酒店集团回应称将加强安全巡检，配合警方调查。', discoveryDate: '2020-12-03', source: '南方都市报' },
  { brands: [], matchMode: 'alert', city: null, hotelName: '行业警示', content: '2020年喆啡酒店某门店客房天花板消防喷淋头旁发现微型摄像头，经警方侦查系有组织的偷拍团伙所为，多名嫌疑人落网。', discoveryDate: '2020-10-15', source: '楚天都市报' },
]
